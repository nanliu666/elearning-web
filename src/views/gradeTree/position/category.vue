    ...
    >
      <span class="flex flex-flow justify-content">
        ...
        <span class="flex flex-flow-column">
          <span>1、您可以将企业的岗位信息进行简单的分类，方便后期进行统计和分析</span>
          <span>2、没有添加岗位类别的岗位，将默认放置在“未分类”下。</span>
        </span>
      </span>
      <span
        class="el-icon-close"
  ...
  methods: {
    handlerDeleteAll(list) {
      ...
      if (name) {
        ...
        this.$confirm(`很抱歉，您选中的岗位类别 ${name} 下存在员工，请先将员工调整后再删除`, {

<template>
  <div class="fill">
    <page-header title="课程分类">
      <el-button
        slot="rightMenu"
        v-p="ADD_COURSE_CATALOG"
        type="primary"
        size="medium"
...
export default {
  ...
  computed: {
    ADD_COURSE_CATALOG: () => ADD_COURSE_CATALOG,
    STOP_COURSE_CATALOG: () => STOP_COURSE_CATALOG,
    AUTH_COURSE_CATALOG: () => AUTH_COURSE_CATALOG,
    EDIT_COURSE_CATALOG: () => EDIT_COURSE_CATALOG,

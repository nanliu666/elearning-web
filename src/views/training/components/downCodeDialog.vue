<template>
  ...
  >
    ...
    <el-table :data="data">
      <el-table-column prop="todoName" align="center" label="课程名称"> </el-table-column>
      ...
      <el-table-column prop="todoTime" align="center" label="授课时间"> </el-table-column>
      <el-table-column prop="date" align="center" label="操作">
        <template slot-scope="scope">
          <el-button type="text" @click="downCodeImg(scope.row)"> 下载二维码 </el-button>
        </template>
      </el-table-column>
    </el-table>
  </el-dialog>
...
export default {
  ...
  methods: {
    downCodeImg(row) {
      ...
      let baseURL = (frontBaseUrl += "/pages/signin/index");

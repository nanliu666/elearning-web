<template>
  <div class="Menu fill">
    <page-header :title="typeConfig[dataType].title" />
...
export default {
  ...
  created() {
    this.tableColumns =
      this.dataType === 'wait' ? TABLE_COLUMNS : [...TABLE_COLUMNS, ...APPROVE_PERSON]
    this.initData()
    this.refreshTableData()
  },
  methods: {
    ...
    async loadTableData() {
      ...
      try {
        ...
        let loadFun = this.typeConfig[this.dataType].loadFun

...
export const DELETEALL_COURSE = '/course/courseDraft/deleteAll' //批量删除
...
export const DELETEALL_COURSE_CATALOG = '/course/catalog/deleteAll' // 批量删除
...
export const DELETE_ALL_REP_CATALOG = '/repository/catalogManagement/deleteAll' // 批量删除分类
